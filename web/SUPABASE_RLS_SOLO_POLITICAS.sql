-- =====================================================
-- SCRIPT SOLO POLÍTICAS - NO TOCA LA FUNCIÓN EXISTENTE
-- =====================================================
-- Este script solo actualiza las políticas sin modificar
-- la función user_has_clinic_access que ya existe
-- =====================================================
...
-- PASO 3: CREAR NUEVAS POLÍTICAS USANDO LA FUNCIÓN EXISTENTE
-- =====================================================
-- NOTA: Usamos user_has_clinic_access que ya existe
...
-- Ver estado de RLS (debe mostrar true para todas):
SELECT
    tablename,
    rowsecurity
FROM pg_tables
...
-- Ver detalle de la función existente:
SELECT
...
-- 2. Usuario A crea workspace A y clínica A
-- 3. Usuario B crea workspace B y clínica B
-- 4. Verifica que A NO puede ver datos de B
-- 5. Verifica que B NO puede ver datos de A
