-- =====================================================
-- SCRIPT DE LIMPIEZA Y CONFIGURACIÓN DE RLS
-- =====================================================
-- Este script primero LIMPIA las políticas existentes
-- y luego las recrea correctamente
-- =====================================================
...
-- PASO 2: RECREAR LA FUNCIÓN (sin DROP ya que tiene dependencias)
-- =====================================================
-- La función ya existe, solo la actualizamos por si acaso
...
-- =====================================================
-- ÉXITO - RLS CONFIGURADO CORRECTAMENTE
-- =====================================================
-- Ahora cada usuario solo puede ver y modificar
-- los datos de sus propias clínicas
-- =====================================================