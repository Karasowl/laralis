      ...
      <div className="max-w-5xl mx-auto">
        <Card className="border-2 shadow-2xl bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl">
          <CardHeader className="text-center border-b pb-6 sm:pb-8 px-6 sm:px-8 lg:px-12">
            <div className="mx-auto mb-4 sm:mb-6 h-14 w-14 sm:h-20 sm:w-20 rounded-full bg-green-100 flex items-center justify-center">
              <Shield className="h-7 w-7 sm:h-10 sm:w-10 text-green-600" />
            </div>
